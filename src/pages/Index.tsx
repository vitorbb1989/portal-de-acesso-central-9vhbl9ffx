...
const Index = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <section className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pb-5 border-b border-border/40 relative">
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2 mt-1">
            <div className="flex items-center gap-1.5 px-2.5 py-1 bg-secondary/30 rounded-md border border-border/40">
              <span className="text-[10px] text-muted-foreground uppercase tracking-wider font-semibold">
                Workspace
              </span>
              <span className="text-xs font-medium text-foreground">AntropIA Corp</span>
            </div>
            <div className="flex items-center gap-1.5 px-2.5 py-1 bg-secondary/30 rounded-md border border-border/40">
              <span className="text-[10px] text-muted-foreground uppercase tracking-wider font-semibold">
                Plano
        ...
        <Button
          asChild
          size="sm"
          className="h-8 px-3 shadow-sm hover:shadow-md hover:bg-primary/90 transition-all text-xs"
        >
      ...
      {!searchQuery && (
        <section className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 px-4 py-3 rounded-lg border border-border/40 bg-secondary/20 shadow-sm relative overflow-hidden">
          <div className="absolute left-0 top-0 bottom-0 w-[2px] bg-status-success/50" />
          ...
          <div className="flex items-center gap-2 text-muted-foreground">
            ...
            <span className="text-xs font-medium">Sincronizado há 2 min</span>
          </div>
        </section>
      )}
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          ...
          {!searchQuery && (
            <Button
              variant="ghost"
              asChild
              className="text-primary hover:text-primary/90 hover:bg-primary/10 transition-colors group h-8 px-2.5 text-xs font-medium"
            >
              <Link to="/platforms">
                Ver todos{' '}
        ...
        {displayedPlatforms.length > 0 ? (
          ...
          <div className="py-12 text-center bg-secondary/20 rounded-lg border border-dashed border-border/60">
