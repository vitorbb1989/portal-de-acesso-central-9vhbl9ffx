...
const Index = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <section className="flex flex-col gap-5 pb-6 border-b border-border/50">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground mb-2">
            Visão Geral do Workspace
          </h1>
          <p className="text-muted-foreground text-lg">
            Seu ambiente está totalmente ativo e pronto para uso. Todos os sistemas operam conforme
            o esperado.
          </p>
        </div>

        <div className="flex flex-wrap items-center gap-3">
          <div className="flex items-center gap-2 px-3 py-1.5 bg-secondary/40 rounded-lg border border-border/60 shadow-sm">
      ...
      {!searchQuery && (
        <section className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 p-4 rounded-xl border border-border/60 bg-gradient-to-r from-secondary/30 to-transparent shadow-sm">
          <div className="flex items-center gap-3">
            <div className="flex h-2.5 w-2.5 rounded-full bg-status-success shadow-[0_0_10px_rgba(16,185,129,0.9)] animate-pulse-slow" />
          ...
          <div className="flex items-center gap-3">
            <div className="flex h-2.5 w-2.5 rounded-full bg-status-warning shadow-[0_0_10px_rgba(245,158,11,0.9)]" />
